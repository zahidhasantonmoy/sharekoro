        ...
        // Check file type
            ...
            try {
                ...
                if (move_uploaded_file($file['tmp_name'], $file_path)) {
                    ...
                    // Insert share
                    $stmt = $pdo->prepare("INSERT INTO shares (share_key, title, file_path, file_name, file_size, share_type, expiration_date, created_by, is_public, password_protect) VALUES (?, ?, ?, ?, ?, 'file', ?, ?, ?, ?)");
                    $stmt->execute([
                        $share_key,
                        $title,
                        $file_path,
