<?php
// share-text.php - Text sharing page
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($content)) {
        ...
        try {
            ...
            // Insert share
            $stmt = $pdo->prepare("INSERT INTO shares (share_key, title, content, share_type, expiration_date, created_by, is_public, password_protect) VALUES (?, ?, ?, 'text', ?, ?, ?, ?)");
            $stmt->execute([
                $share_key,
                $title,
                $content,
