...
<body>
    ...
    <main class="container">
        <div class="auth-form glassmorphism">
            <h2><i class="fas fa-code"></i> Share Code</h2>
            ...
            <?php if (!$success): ?>
                <form method="POST" action="">
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" placeholder="Enter a title for your code snippet">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="content" name="content" rows="15" required placeholder="Paste your code here..."></textarea>
                    </div>
    ...
    <script>
        ...
        function shareToTwitter(url, title) {
            const text = title ? encodeURIComponent(title) : encodeURIComponent('Check out this code snippet');
